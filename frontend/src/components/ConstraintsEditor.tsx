    ...
    <div className="mb-3">
      ...
      <div className="flex gap-2 mt-2">
        ...
        <input
          ...
          className="w-20 bg-ink border border-edge rounded px-2 py-1 text-xs"
        />
        <button
          type="button"
          onClick={() => {
          ...
          className="text-accent text-xs border border-accent/30 rounded px-2 hover:bg-accent/10"
        >
          +
        </button>
      </div>
