"""QC endpoints: report ingest + typed measurements.

POST /api/qc/report — upload a test certificate → extracted measurements bound
     to an experiment.
GET  /api/qc/experiments/{id}/measurements — per-measurement rows.
GET  /api/qc/workbench/{campaign}/rows/{row}/measurements — workbench rows.
"""
