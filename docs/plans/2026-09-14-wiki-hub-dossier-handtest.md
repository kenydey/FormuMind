...
| R2b | 看 Reports 顶栏 **灰度旗标** | Wiki/卷宗/Report ✓ 或 ×；未开时「去设置开启」→ Settings · 环境变量并**锚到**缺失旗标行；保存后 Reports 条自动刷新（见 `2026-09-18-hub-reports-flag-observability.md` · `2026-09-18-envflags-focus-anchor.md` · `2026-09-18-reports-flags-refresh-on-env-save.md`） |
